 ...
 */
package CapaPresentación.LoginRegistro;
...
public class frmLogin extends javax.swing.JFrame {
    ...
    private void validarDatos() {
        ...
        if (password.equals("") || Usuario.equals("")) {
            ...
            try {
                ...
                Connection conectar = conecta.conectar(); 
                PreparedStatement seleccionar = conectar.prepareStatement("SELECT * FROM login WHERE usuario='"+Usuario+"' and pasword='"+password+"'");
                ...
                if (consulta.next()) {
                    ...
                    if ( usuarioEncontrado == true) {
                        ...
                        conecta.cerrarConexion(conectar);
                    }
                } else {
    ...
    private void initComponents() {
        ...
        jPanel1 = new CapaPresentación.LoginRegistro.RoundedPanel();
